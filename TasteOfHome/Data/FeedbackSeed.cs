    ...
    public class FeedbackSeed
    {
        public static List<Feedback> GetFeedbacks()
        {
            return new List<Feedback>
            {
                ...
                new Feedback(2, 55, "Spice levels felt toned down.", 1),
                new Feedback(4, 83, "Great halal options and friendly service.", 1),
                new Feedback(3, 68, "Decent, but not memorable.", 1),
                new Feedback(5, 94, "Butter chicken was outstanding.", 1),
                new Feedback(4, 80, "Good value for the portions.", 1),
                new Feedback(1, 40, "Overcooked rice ruined the meal.", 1),
                ...
                new Feedback(3, 70, "Healthy but a bit bland.", 2),
                new Feedback(4, 80, "Great sauces and variety.", 2),
                new Feedback(2, 60, "Portions felt small.", 2),
                ...
                new Feedback(3, 72, "Good but portions were smaller.", 4),
                new Feedback(4, 80, "Great halal option in Mississauga.", 4),
                new Feedback(2, 60, "Rice was a bit dry.", 4),
                ...
                new Feedback(1, 48, "Overcooked kebab.", 4),
                ...
                new Feedback(2, 60, "Wait time was long.", 5),
                new Feedback(5, 93, "Authentic Italian comfort food.", 5),
                new Feedback(4, 80, "Cozy atmosphere and friendly staff.", 5),
                new Feedback(3, 70, "Good but not exceptional.", 5),
                ...
                new Feedback(1, 42, "Food arrived late.", 8),
                ...
                new Feedback(4, 80, "Great tacos.", 9),
                new Feedback(2, 60, "Dry tortillas.", 9),
                ...
                new Feedback(1, 48, "Too greasy.", 10),
                ...
                new Feedback(1, 45, "Too salty.", 11),
                new Feedback(5, 98, "True Punjabi taste.", 11),
                new Feedback(4, 83, "Always satisfying.", 11),
                new Feedback(3, 74, "Solid choice.", 11),
                ...
                new Feedback(2, 60, "Too mild for Thai food.", 12),
                ...
                new Feedback(1, 48, "Food arrived lukewarm.", 12),
                ...
                new Feedback(5, 96, "One of Toronto’s best.", 13),
                ...
                new Feedback(4, 84, "Highly recommend.", 13),
                new Feedback(3, 74, "Solid meal.", 13),
